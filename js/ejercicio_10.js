...
// elija. 
// Solo se puede elegir un ingrediente además de la mozzarella y el tomate que están
...
let pizza = prompt('Ingresa SI quieres o NO, una pizza vegetariana').toLowerCase();
